...
val Color.Companion.DarkSurface
    get() = Color(0xFF101010)
val Color.Companion.DarkContainer: Color
    get() = Color(0xFF1A1A1A)
val Color.Companion.DarkDefaultText: Color
    get() = Color(0xFFBCBEC1)
val Color.Companion.DarkSecondaryText: Color
    get() = Color(0xFF808080)
val Color.Companion.DarkTertiaryText: Color
    get() = Color(0xFF4F4F4F)
val Color.Companion.MainAccentBlue: Color
    get() = Color(0xFF2761F4)
val Color.Companion.MainAccentBlueGlow: Color
    get() = Color(0xFF55D6F4)
